...
if __name__ == '__main__':
    ...
    # other system
    other_receiver_agent_aid = AID(name='receiver@192.168.1.7:{}'.format(30001))
    
    # current system
    sender_agent_aid = AID(name='sender@192.168.1.10:{}'.format(30000))
    sender_agent = SenderAgent(sender_agent_aid, other_receiver_agent_aid, True)
    agents.append(sender_agent)

    receiver_agent_aid = AID(name='receiver@192.168.1.10:{}'.format(30001))
